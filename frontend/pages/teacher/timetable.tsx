  ...
  const Sidebar = () => (
    <aside className={`w-64 bg-white dark:bg-[#1a2632] border-r border-gray-200 dark:border-gray-700 flex-col h-full shrink-0 z-20 transition-all duration-300 ${sidebarOpen ? 'absolute inset-y-0 left-0 flex' : 'hidden lg:flex'}`}>
      ...
      <nav className="flex-1 px-4 flex flex-col gap-2 overflow-y-auto">
        ...
        <Link href="/teacher/messages" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
          <span className="material-symbols-outlined text-xl">mail</span>
          <span className="text-sm font-medium">Messages</span>
        </Link>
        {/* Active Item */}
        <Link href="/teacher/timetable" className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-primary/10 text-primary dark:text-primary">
  ...
  return (
    <AuthGuard>
      <RoleGuard allowedRoles={[USER_ROLES.SUPER_ADMIN, USER_ROLES.TEACHER]}>
        <Head>
          <title>Timetable - School ERP</title>
        </Head>
          ...
          <div className="flex flex-1 flex-col h-full overflow-hidden relative">
            ...
            <header className="hidden lg:flex flex-none items-center justify-between whitespace-nowrap border-b border-solid border-[#e7edf3] dark:border-gray-800 bg-white dark:bg-[#1a2632] px-10 py-3 z-20">
              <div className="flex items-center gap-2 text-sm text-slate-500">
                ...
                <span>/</span>
                <span className="text-slate-900 dark:text-white font-medium">Timetable Management</span>
              </div>
              <div className="flex flex-1 justify-end gap-6 items-center">
                <label className="flex flex-col min-w-40 !h-10 max-w-64 hidden md:flex">
                  <div className="flex w-full flex-1 items-stretch rounded-lg h-full">
                    ...
                    <input className="flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-[#0d141b] dark:text-white focus:outline-0 focus:ring-0 border-none bg-[#e7edf3] dark:bg-gray-800 focus:border-none h-full placeholder:text-[#4c739a] px-4 rounded-l-none border-l-0 pl-2 text-sm font-normal leading-normal" placeholder="Search..." />
                  </div>
                </label>
                <div className="flex items-center gap-3">
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                <div className="p-6 md:p-8 flex-1 overflow-auto">
                  <div className="bg-white dark:bg-[#1a2632] rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 min-w-[800px] overflow-hidden">
                    ...
                    <div className="relative grid grid-cols-[80px_1fr_1fr_1fr_1fr_1fr] auto-rows-[100px] divide-y divide-gray-100 dark:divide-gray-800">
                      ...
                      {/* ... more cells ... for brevity simulating the row structure */}
              ...
              <aside className="w-80 bg-white dark:bg-[#1a2632] border-l border-gray-200 dark:border-gray-800 flex flex-col z-10 shadow-lg hidden xl:flex">
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-3">
                  {/* Card 1 */}
                  <div className="p-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm hover:shadow-md hover:border-primary cursor-grab group transition-all">
