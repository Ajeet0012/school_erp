...
export default function ForgotPassword() {
    ...
    const onSubmit = async (data: ForgotPasswordValues) => {
        ...
        try {
            ...
            setSubmitted(true);
            toast.success('Security cipher recovery link dispatched.');
        } catch (err: any) {
    ...
    if (submitted) {
        return (
            <AuthLayout title="Cipher Recovery Sent">
                <div className="text-center space-y-8">
                    ...
                    <div className="space-y-4">
                        <h2 className="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-widest">Protocol Initiated</h2>
                        <p className="text-sm font-medium text-slate-500 italic px-4 leading-relaxed">
                            We have dispatched a security cipher recovery transmission to your institutional ID. Please verify your inbox to synchronize further.
                        </p>
                    </div>
                    <div className="pt-4 flex flex-col gap-4">
                        ...
                        <button onClick={() => setSubmitted(false)} className="text-[10px] font-black text-slate-400 uppercase tracking-widest hover:text-primary transition-colors">
                            Didn't receive transmission? Try again
                        </button>
                    </div>
                </div>
            </AuthLayout>
    ...
    return (
        <AuthLayout title="Cipher Recovery">
            <div className="space-y-8">
                <div className="flex flex-col items-center">
                    ...
                    <div className="text-center">
                        <h2 className="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-widest leading-none mb-3">Cipher Recovery</h2>
                        <p className="text-sm font-medium text-slate-500 italic">Initiate security bypass protocol for your lost credentials.</p>
                    </div>
                </div>
